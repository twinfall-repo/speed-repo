...
This module orchestrates the complete workflow for extracting mesh refinement
...
from .curve_extraction import extract_refinement_curves, close_curves_to_boundary
...
from .curve_visualization import debug_visualization
...
def main() -> None:
    ...
    # Configuration
    # folder = "/home/elle/Dropbox/Work/PresentazioniArticoli/progetti/cariplo/cubit_python/CubitPython4SPEED/Files/test/"
    ...
    folder = "/home/elle/Dropbox/Work/PresentazioniArticoli/progetti/cariplo/cubit_python/CubitPython4SPEED/Files/rialba/"
