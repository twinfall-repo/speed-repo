"""Monitor file processing utilities for MATLAB-style monitor files.

This module provides utilities to process, read, and write SPEED monitor files.
Functions include type hints and runtime checks to be friendly to static checkers
such as `mypy`.
"""
